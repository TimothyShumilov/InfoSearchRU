...
def get_task_def_by_task_name_and_type(task_name: str, task_type: str) -> str:
    ...
    if task_type in ['Retrieval']:
        ...
        task_name_to_instruct: Dict[str, str] = {
            ...
            "Clarity-v1": "Given a question, retrieve news articles that answer the question",
            "Source-v1": "Given a question, retrieve news articles that answer the question",
            "Audience-v1": "Given a question, retrieve news articles that answer the question",
            "Language-v1": "Given a question, retrieve news articles that answer the question",
            "Length-v1": "Given a question, retrieve news articles that answer the question",
            "Format-v1": "Given a question, retrieve news articles that answer the question",
            "Test-1": "Given a question, retrieve news articles that answer the question",
            "Test-2": "Given a question, retrieve news articles that answer the question",
            "Clarity-v1-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
            "Source-v1-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
            "Audience-v1-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
            "Language-v1-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
            "Length-v1-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
            "InstructedRetrieval-val-ru": "Извлеки новостные статьи, которые отвечают на следующий вопрос:",
